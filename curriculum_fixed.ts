...
export const curriculumLevels: CurriculumLevel[] = [
  {
      ...
      sections: [
        {
          ...
          slides: [
            ...
            { id: "Diapositiva 3", title: "Objectives", description: "Manejar saludos y despedidas básicas en contextos formales e informales.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
        ...
        },
        {
          ...
          duration: "20 minutos",
          objective: "Presentar el tema principal: 11: Saludos, despedidas y conversación de supervivencia.",
          slides: [
            ...
            { id: "Diapositiva 7", title: "Grammar Structure", description: "How to form sentences.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-500 to-emerald-600" },
            { id: "Diapositiva 8", title: "Practice Sentences", description: "Repeat after the teacher.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1495364141860-b0d03eccd065?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Example A"], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
      ...
      sections: [
        {
          ...
          slides: [
            ...
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Deletrear información personal correctamente.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 12: Alfabeto, deletreo, correos electrónicos y datos personales.",
          slides: [
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Hablar de ocupaciones y origen.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 13: Profesiones, nacionalidades y preguntas con to be.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Expresar acciones diarias simples.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 14: Rutinas muy básicas con have, go, work, study.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Preguntar precios y realizar compras simuladas.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 15: Compras: precios, dinero, How much is it?.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
    ...
    },
    {
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Consolidar todo lo aprendido en el nivel.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 16: Repaso integral y conversación guiada del nivel.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      virtualEvaluation: [
                      ...
                      },
          {
...
}a3c4ef2046f?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            ...
            { id: "Diapositiva 7", title: "Grammar Structure", description: "How to form sentences.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1518173946687-a4c8892bbd9f?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-500 to-emerald-600" },
            { id: "Diapositiva 8", title: "Practice Sentences", description: "Repeat after the teacher.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1494537176433-7a3c4ef2046f?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Let's review the main topics."], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
            { id: "Diapositiva 10", title: "Quick Check", description: "Do you have any questions?", bgColor: "bg-gradient-to-br from-cyan-600 to-blue-700" }
          ],
          action: "Tomar notas y repetir pronunciación."
        },
    ...
    }e", description: "Talk with your partner.", type: "speaking", bgColor: "bg-gradient-to-br from-pink-500 to-rose-600" },
            { id: "Diapositiva 17", title: "Roleplay", description: "Act out a situation.", type: "roleplay", bgColor: "bg-gradient-to-br from-pink-600 to-rose-700" },
            { id: "Diapositiva 18", title: "Share", description: "Share with the class.", bgColor: "bg-gradient-to-br from-rose-500 to-pink-600" }
          ],
          action: "Conversar libremente."
...
},
  {
      ...
      sections: [
        {
          ...
          slides: [
            ...
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Usar cuantificadores con comida y objetos cotidianos.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 5: Sustantivos contables/no contables: some, any, a lot of.",
          slides: [
            { id: "Diapositiva 4", title: "Important Topic", description: "Introduction to Important Topic.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1494537176433-7a3c4ef2046f?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            ...
            { id: "Diapositiva 7", title: "Grammar Structure", description: "How to form sentences.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1494537176433-7a3c4ef2046f?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-500 to-emerald-600" },
            { id: "Diapositiva 8", title: "Practice Sentences", description: "Repeat after the teacher.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Example A"], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
            { id: "Diapositiva 10", title: "Quick Check", description: "Do you have any questions?", bgColor: "bg-gradient-to-br from-cyan-600 to-blue-700" }
          ],
          action: "Tomar notas y repetir pronunciación."
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Expresar qué te gusta y qué desearías.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 6: Gustos y preferencias: like, would like, favorite.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Dar y entender instrucciones.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 7: Imperativos e instrucciones: open, close, turn left, please.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Manejar solicitudes con cortesía.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 8: Pedir y ofrecer ayuda: Can I...?, Can you...?, Could you...?.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Manejar llamadas telefónicas sencillas.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 9: Llamadas básicas: saludar, pedir repetir, tomar un mensaje.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Aplicar todo lo aprendido colaborativamente.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 10: Proyecto: planear una salida, viaje o evento futuro.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
...
}iption: "Let's read these phrases.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1543269865-cbf427effbad?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary Words", description: "Review, Practice, Exercise, Test", content: ["Review", " Practice", " Exercise", " Test"], imageUrl: "https://images.unsplash.com/photo-1552581234-26160f608093?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
            { id: "Diapositiva 7", title: "Grammar Structure", description: "How to form sentences.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-500 to-emerald-600" },
            { id: "Diapositiva 8", title: "Practice Sentences", description: "Repeat after the teacher.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Let's review the main topics."], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
            { id: "Diapositiva 10", title: "Quick Check", description: "Do you have any questions?", bgColor: "bg-gradient-to-br from-cyan-600 to-blue-700" }
          ],
          action: "Tomar notas y repetir pronunciación."
    ...
    }Time", description: "Talk with your partner.", type: "speaking", bgColor: "bg-gradient-to-br from-pink-500 to-rose-600" },
            { id: "Diapositiva 17", title: "Roleplay", description: "Act out a situation.", type: "roleplay", bgColor: "bg-gradient-to-br from-pink-600 to-rose-700" },
            { id: "Diapositiva 18", title: "Share", description: "Share with the class.", bgColor: "bg-gradient-to-br from-rose-500 to-pink-600" }
          ],
          action: "Conversar libremente."
      ...
      sections: [
        {
          ...
          slides: [
            ...
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Hablar de lo que pueden o no pueden hacer.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 5: Can / can’t para habilidades y permisos.",
          slides: [
            ...
            { id: "Diapositiva 7", title: "Grammar Structure", description: "How to form sentences.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-500 to-emerald-600" },
            { id: "Diapositiva 8", title: "Practice Sentences", description: "Repeat after the teacher.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Example A"], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
            { id: "Diapositiva 10", title: "Quick Check", description: "Do you have any questions?", bgColor: "bg-gradient-to-br from-cyan-600 to-blue-700" }
          ],
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Expresar responsabilidades y falta de necesidad.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 6: Have to / don’t have to para obligaciones.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Describir el aspecto de personas.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 7: Describir ropa y apariencia física.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Direcciones y medios de transporte.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 8: Lugares, transporte y cómo llegar.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Hablar de condiciones meteorológicas.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 9: Clima y actividades según el clima.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Customer service elemental.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 10: Conversación de servicio básico: pedidos, horarios, disponibilidad.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Cerrar nivel 2.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 11: Repaso y evaluación oral de presente, futuro y preguntas.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          objective: "Presentar el tema principal: 11: Repaso y evaluación oral de presente, futuro y preguntas.",
          slides: [
            { id: "Diapositiva 4", title: "Review & Practice", description: "Introduction to Review & Practice.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1552581234-26160f608093?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples in Context", description: "Let's read these phrases.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1494537176433-7a3c4ef2046f?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary Words", description: "Review, Practice, Exercise, Test", content: ["Review", " Practice", " Exercise", " Test"], imageUrl: "https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
            { id: "Diapositiva 7", title: "Grammar Structure", description: "How to form sentences.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1543269865-cbf427effbad?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-500 to-emerald-600" },
            { id: "Diapositiva 8", title: "Practice Sentences", description: "Repeat after the teacher.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1543269865-cbf427effbad?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Let's review the main topics."], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
            { id: "Diapositiva 10", title: "Quick Check", description: "Do you have any questions?", bgColor: "bg-gradient-to-br from-cyan-600 to-blue-700" }
          ],
          action: "Tomar notas y repetir pronunciación."
      ...
      sections: [
        {
          ...
          slides: [
            ...
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Describir situaciones en el pasado con el verbo to be.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 5: Pasado de to be: was/were.",
          slides: [
            ...
            { id: "Diapositiva 7", title: "Grammar Structure", description: "How to form sentences.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-500 to-emerald-600" },
            { id: "Diapositiva 8", title: "Practice Sentences", description: "Repeat after the teacher.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1552581234-26160f608093?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Example A"], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
            { id: "Diapositiva 10", title: "Quick Check", description: "Do you have any questions?", bgColor: "bg-gradient-to-br from-cyan-600 to-blue-700" }
          ],
          action: "Tomar notas y repetir pronunciación."
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Relatar eventos pasados.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 6: Biografías y eventos históricos sencillos.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Hablar de viajes pasados usando verbos irregulares.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 7: Viajes y vacaciones en pasado.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Secuenciar narraciones pasadas.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 8: Conectores para contar historias: first, then, after that, finally.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Dar críticas y opiniones sencillas.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 9: Expresar opiniones sobre películas, comida y experiencias.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Customer service en pasado.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 10: Llamadas sobre problemas pasados: 'My order arrived late.'.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Cerrar nivel 3 con evaluación narrativa.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 11: Repaso narrativo y prueba oral de pasado.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          objective: "Romper el hielo y activar conocimientos previos.",
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started with Review & Practice.", imageUrl: "https://images.unsplash.com/photo-1495364141860-b0d03eccd065?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Cerrar nivel 3 con evaluación narrativa.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          slides: [
            ...
            { id: "Diapositiva 6", title: "Vocabulary Words", description: "Review, Practice, Exercise, Test", content: ["Review", " Practice", " Exercise", " Test"], imageUrl: "https://images.unsplash.com/photo-1518173946687-a4c8892bbd9f?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
            { id: "Diapositiva 7", title: "Grammar Structure", description: "How to form sentences.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-500 to-emerald-600" },
            { id: "Diapositiva 8", title: "Practice Sentences", description: "Repeat after the teacher.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Let's review the main topics."], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
            { id: "Diapositiva 10", title: "Quick Check", description: "Do you have any questions?", bgColor: "bg-gradient-to-br from-cyan-600 to-blue-700" }
          ],
          action: "Tomar notas y repetir pronunciación."
...
},
  {
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started with Important Topic.", imageUrl: "https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Hablar de posibilidades futuras.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 5: Primer condicional: If it rains, I will....",
          slides: [
            ...
            { id: "Diapositiva 6", title: "Vocabulary Words", description: "Word 1, Word 2, Word 3", content: ["Word 1", " Word 2", " Word 3"], imageUrl: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
            { id: "Diapositiva 7", title: "Grammar Structure", description: "How to form sentences.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1543269865-cbf427effbad?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-500 to-emerald-600" },
            { id: "Diapositiva 8", title: "Practice Sentences", description: "Repeat after the teacher.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1495364141860-b0d03eccd065?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Example A"], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
            { id: "Diapositiva 10", title: "Quick Check", description: "Do you have any questions?", bgColor: "bg-gradient-to-br from-cyan-600 to-blue-700" }
          ],
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Usar modales adecuadamente.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 6: Modales de habilidad, permiso y posibilidad: can, could, may, might.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Comparar opciones.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 7: Comparativos y superlativos aplicados a productos y servicios.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Enfatizar descripciones.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 8: Too, enough, very, so, such.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Manejar problemas con clientes.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 9: Quejas y soluciones básicas para customer service.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Escribir correspondencia profesional básica.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 10: Emails y mensajes cortos formales.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Evaluar habilidades integradas.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 11: Simulación de atención al cliente y Examen de transición.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        ...
        },
        {
          ...
          slides: [
            ...
            { id: "Diapositiva 6", title: "Vocabulary Words", description: "Word 1, Word 2, Word 3", content: ["Word 1", " Word 2", " Word 3"], imageUrl: "https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
            { id: "Diapositiva 7", title: "Grammar Structure", description: "How to form sentences.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-500 to-emerald-600" },
            { id: "Diapositiva 8", title: "Practice Sentences", description: "Repeat after the teacher.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Example A"], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
            { id: "Diapositiva 10", title: "Quick Check", description: "Do you have any questions?", bgColor: "bg-gradient-to-br from-cyan-600 to-blue-700" }
          ],
          action: "Tomar notas y repetir pronunciación."
    ...
    }ng Time", description: "Talk with your partner.", type: "speaking", bgColor: "bg-gradient-to-br from-pink-500 to-rose-600" },
            { id: "Diapositiva 17", title: "Roleplay", description: "Act out a situation.", type: "roleplay", bgColor: "bg-gradient-to-br from-pink-600 to-rose-700" },
            { id: "Diapositiva 18", title: "Share", description: "Share with the class.", bgColor: "bg-gradient-to-br from-rose-500 to-pink-600" }
          ],
          action: "Conversar libremente."
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started with Important Topic.", imageUrl: "https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Usar Present Perfect con marcadores de tiempo.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 7: Present Perfect con already, yet, just, ever, never.",
          slides: [
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Describir acciones recientes en curso.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 8: Present Perfect Continuous.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Predecir consecuencias realistas.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 9: Primer condicional y futuro probable.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Deducir situaciones y expresar probabilidad.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 10: Modales de posibilidad: may, might, could, must.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Usar correctamente gerundios e infinitivos.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 11: Gerundios e infinitivos: want to, need to, enjoy doing.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Integrar verbos compuestos comunes.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 12: Phrasal verbs frecuentes de conversación.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Atención al cliente telefónica intermedia.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 13: Llamadas de soporte: verificar datos, solucionar y cerrar casos.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Mejorar la fluidez y naturalidad.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 14: Pronunciación: entonación, connected speech y reducción.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Demostrar fluidez en atención al cliente.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 15: Proyecto: resolver un caso completo de customer service.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
...
}eacher.", content: ["Intonation", "Connected Speech"], imageUrl: "https://images.unsplash.com/photo-1525362081669-2b476bb628c3?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Intonation"], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
            { id: "Diapositiva 10", title: "Quick Check", description: "Do you have any questions?", bgColor: "bg-gradient-to-br from-cyan-600 to-blue-700" }
          ],
          action: "Tomar notas y repetir pronunciación."
        },
      ...
      sections: [
        {
          ...
          objective: "Romper el hielo y activar conocimientos previos.",
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started with Review & Practice.", imageUrl: "https://images.unsplash.com/photo-1525362081669-2b476bb628c3?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Demostrar fluidez en atención al cliente.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          slides: [
            ...
            { id: "Diapositiva 7", title: "Grammar Structure", description: "How to form sentences.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1495364141860-b0d03eccd065?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-500 to-emerald-600" },
            { id: "Diapositiva 8", title: "Practice Sentences", description: "Repeat after the teacher.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1543269865-cbf427effbad?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Let's review the main topics."], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
            { id: "Diapositiva 10", title: "Quick Check", description: "Do you have any questions?", bgColor: "bg-gradient-to-br from-cyan-600 to-blue-700" }
          ],
...
},
  {
      ...
      sections: [
        {
          ...
          slides: [
            ...
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Dominar todas las formas condicionales.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 5: Todos los condicionales: cero, primero, segundo, tercero y mixtos.",
          slides: [
            { id: "Diapositiva 4", title: "Important Topic", description: "Introduction to Important Topic.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples in Context", description: "Let's read these phrases.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1552581234-26160f608093?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            ...
            { id: "Diapositiva 7", title: "Grammar Structure", description: "How to form sentences.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1552581234-26160f608093?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-500 to-emerald-600" },
            { id: "Diapositiva 8", title: "Practice Sentences", description: "Repeat after the teacher.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1543269865-cbf427effbad?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Example A"], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
            { id: "Diapositiva 10", title: "Quick Check", description: "Do you have any questions?", bgColor: "bg-gradient-to-br from-cyan-600 to-blue-700" }
          ],
          action: "Tomar notas y repetir pronunciación."
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Reportar exactamente lo dicho por otros.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 6: Reported speech para preguntas, órdenes y solicitudes.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Añadir detalles complejos a las descripciones.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 7: Relative clauses: who, which, that, where.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Sonar más nativo en entornos de negocios.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 8: Phrasal verbs profesionales y expresiones idiomáticas.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Técnicas de soft skills en inglés.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 9: Negociación, persuasión y manejo de clientes difíciles.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Escritura avanzada de negocios.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 10: Correos corporativos: disculpas, seguimiento, escalamiento.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Reducir el acento fuerte en el teléfono.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 11: Pronunciación para llamadas: ritmo, énfasis, claridad y neutralización.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Evaluar competencias nivel Avanzado.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 12: Simulaciones completas de entrevistas y customer service.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
    ...
    } description: "Talk with your partner.", type: "speaking", bgColor: "bg-gradient-to-br from-pink-500 to-rose-600" },
            { id: "Diapositiva 17", title: "Roleplay", description: "Act out a situation.", type: "roleplay", bgColor: "bg-gradient-to-br from-pink-600 to-rose-700" },
            { id: "Diapositiva 18", title: "Share", description: "Share with the class.", bgColor: "bg-gradient-to-br from-rose-500 to-pink-600" }
          ],
          action: "Conversar libremente."
...
},
  {
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started with Important Topic.", imageUrl: "https://images.unsplash.com/photo-1543269865-cbf427effbad?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Proyecciones a largo plazo y duración en el futuro.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 6: Future Continuous y Future Perfect Continuous.",
          slides: [
            { id: "Diapositiva 4", title: "Important Topic", description: "Introduction to Important Topic.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1494537176433-7a3c4ef2046f?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples in Context", description: "Let's read these phrases.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1525362081669-2b476bb628c3?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary Words", description: "Word 1, Word 2, Word 3", content: ["Word 1", " Word 2", " Word 3"], imageUrl: "https://images.unsplash.com/photo-1518173946687-a4c8892bbd9f?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
            { id: "Diapositiva 7", title: "Grammar Structure", description: "How to form sentences.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1525362081669-2b476bb628c3?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-500 to-emerald-600" },
            { id: "Diapositiva 8", title: "Practice Sentences", description: "Repeat after the teacher.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Example A"], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
            { id: "Diapositiva 10", title: "Quick Check", description: "Do you have any questions?", bgColor: "bg-gradient-to-br from-cyan-600 to-blue-700" }
          ],
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Estructuras enfáticas avanzadas C1.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 7: Inversiones para énfasis: Never have I..., Rarely do we....",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Focalizar información en discursos.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 8: Cleft sentences: What I mean is..., It was... who....",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Suavizar el lenguaje corporativo.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 9: Hedging y lenguaje diplomático: It seems that, I would suggest....",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Manejar reuniones complejas en inglés.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 10: Discurso persuasivo, presentaciones y reuniones.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Customer service avanzado B2/C1.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 11: Manejo de crisis, escalamiento y negociación compleja.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Redacción C1.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 12: Escritura profesional avanzada: informes, propuestas y emails sensibles.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Evaluación final de Elite.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 13: Pronunciación C1 y Proyecto final (simulación laboral).",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
    ...
    }scription: "Talk with your partner.", type: "speaking", bgColor: "bg-gradient-to-br from-pink-500 to-rose-600" },
            { id: "Diapositiva 17", title: "Roleplay", description: "Act out a situation.", type: "roleplay", bgColor: "bg-gradient-to-br from-pink-600 to-rose-700" },
            { id: "Diapositiva 18", title: "Share", description: "Share with the class.", bgColor: "bg-gradient-to-br from-rose-500 to-pink-600" }
          ],
          action: "Conversar libremente."
      ...
      sections: [
        {
          ...
          objective: "Romper el hielo y activar conocimientos previos.",
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started with Review & Practice.", imageUrl: "https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Evaluación final de Elite.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started with Important Topic.", imageUrl: "https://images.unsplash.com/photo-1552581234-26160f608093?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Habilidades de debate fluido.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 5: Debate formal y refutación de argumentos.",
          slides: [
            { id: "Diapositiva 4", title: "Important Topic", description: "Introduction to Important Topic.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1543269865-cbf427effbad?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples in Context", description: "Let's read these phrases.", content: ["Example A", "Example B"], imageUrl: "https://images.unsplash.com/photo-1518173946687-a4c8892bbd9f?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary Words", description: "Word 1, Word 2, Word 3", content: ["Word 1", " Word 2", " Word 3"], imageUrl: "https://images.unsplash.com/photo-1552581234-26160f608093?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Narración espontánea y atractiva.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 6: Storytelling avanzado y presentaciones improvisadas.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Lenguaje de liderazgo C2.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 7: Inglés para negocios, liderazgo y reuniones.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Analizar y debatir actualidad.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 8: Medios, noticias, cultura y análisis de contenido real.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Comprender humor y matices sutiles.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 9: Humor, ironía, matices y lenguaje informal natural.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Exponer a distintos acentos (UK, Aus, etc.).", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 10: Acentos del inglés y comprensión auditiva avanzada.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Habilidades de entrevista de alto nivel.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 11: Preparación para entrevistas C1/C2 y Conversation Club temático.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
      ...
      sections: [
        {
          ...
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started.", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Culminación del programa y evaluación fluidez.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          title: "2. Grammar / Vocabulary",
          duration: "20 minutos",
          objective: "Presentar el tema principal: 12: Proyecto final: presentación, debate o podcast en inglés.",
          slides: [
            { id: "Diapositiva 4", title: "Concept 1", description: "Introduction to the main concept.", bgColor: "bg-gradient-to-br from-emerald-400 to-teal-500" },
            { id: "Diapositiva 5", title: "Examples", description: "Look at these examples.", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary", description: "Key words for today.", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
...
}th the class.", bgColor: "bg-gradient-to-br from-rose-500 to-pink-600" }
          ],
          action: "Conversar libremente."
        },
        {
      ...
      sections: [
        {
          ...
          objective: "Romper el hielo y activar conocimientos previos.",
          slides: [
            { id: "Diapositiva 1", title: "Welcome!", description: "Hello everyone! Let's get started with Review & Practice.", imageUrl: "https://images.unsplash.com/photo-1552581234-26160f608093?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-blue-400 to-cyan-600" },
            { id: "Diapositiva 2", title: "Warm-up Activity", description: "Let's discuss: What do you know about today's topic?", bgColor: "bg-gradient-to-br from-blue-500 to-cyan-700" },
            { id: "Diapositiva 3", title: "Objectives", description: "Culminación del programa y evaluación fluidez.", bgColor: "bg-gradient-to-br from-indigo-500 to-purple-600" }
          ],
          action: "Participar en la discusión."
        },
        {
          ...
          slides: [
            ...
            { id: "Diapositiva 5", title: "Examples in Context", description: "Let's read these phrases.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1525362081669-2b476bb628c3?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-500 to-teal-600" },
            { id: "Diapositiva 6", title: "Vocabulary Words", description: "Review, Practice, Exercise, Test", content: ["Review", " Practice", " Exercise", " Test"], imageUrl: "https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-emerald-600 to-teal-700" },
            { id: "Diapositiva 7", title: "Grammar Structure", description: "How to form sentences.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1495364141860-b0d03eccd065?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-500 to-emerald-600" },
            { id: "Diapositiva 8", title: "Practice Sentences", description: "Repeat after the teacher.", content: ["Let's review the main topics.", "Practice what we learned."], imageUrl: "https://images.unsplash.com/photo-1495364141860-b0d03eccd065?auto=format&fit=crop&q=80&w=800", bgColor: "bg-gradient-to-br from-teal-600 to-emerald-700" },
            { id: "Diapositiva 9", title: "Pronunciation", description: "Listen carefully.", content: ["Repeat: Let's review the main topics."], bgColor: "bg-gradient-to-br from-teal-700 to-emerald-800" },
            { id: "Diapositiva 10", title: "Quick Check", description: "Do you have any questions?", bgColor: "bg-gradient-to-br from-cyan-600 to-blue-700" }
          ],
          action: "Tomar notas y repetir pronunciación."
