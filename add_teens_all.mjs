...
const existingLevelsToUpdate = [
  {
    id: "basic-zero", // This is Basic Zero
    newClasses: `
    ,
    {
...
existingLevelsToUpdate.forEach(level => {
  const targetStr = '"id": "' + level.id + '"';
  const startIdx = content.indexOf(targetStr);
  if (startIdx !== -1) {
    let nextLevelStart = content.indexOf('  {\n    "id": "basic-', startIdx + 10);
    if (nextLevelStart === -1) {
       nextLevelStart = content.indexOf('  {\n    "id": "teens-', startIdx + 10);
    }
    if (nextLevelStart === -1) {
       nextLevelStart = content.length;
    }
    
    // The classes array ends before the next level or EOF. We search backwards from nextLevelStart for `    ]\n  }`
    const endStr = '    ]\n  }';
    let endIdx = content.lastIndexOf(endStr, nextLevelStart);
    if (endIdx === -1) {
        endIdx = content.lastIndexOf('    ]\n  },', nextLevelStart);
    }
    
    if (endIdx !== -1) {
      content = content.slice(0, endIdx) + level.newClasses + "\\n" + content.slice(endIdx);
      successCount++;
    } else {
      console.log("Failed to find end of classes for level:", level.id);
    }
  } else {
    console.log("Failed to find existing level with id:", level.id);
  }
});

// Now we need to append the NEW LEVELS to the end of the array.
const newLevels = `
  ,{
    "id": "teens-basic-4",
    "title": "Level 4 - Basic 4 (Teen Startup)",
    "duration": "10 clases (1 mes)",
    "objective": "Expresar opiniones, dar consejos y hablar de condiciones.",
    "mcfrEquivalent": "A2",
    "classes": [
    {
      "id": "c-teens-basic-4-1",
      "title": "Clase 1: Primer condicional para planes y consecuencias",
      "duration": "60 min",
    ...
    },
    {
      ...
      "title": "Clase 2: Comparativos y superlativos: apps, celulares, películas y deportes",
      "duration": "60 min",
    ...
    },
    {
      ...
      "title": "Clase 3: Too / enough para problemas y soluciones",
      "duration": "60 min",
    ...
    },
    {
      ...
      "title": "Clase 4: Consejos entre amigos con should",
      "duration": "60 min",
    ...
    },
    {
      ...
      "title": "Clase 5: Mensajes, emails y chats informales/formales",
      "duration": "60 min",
    ...
    },
    {
      ...
      "title": "Clase 6: Atención al cliente juvenil y evaluación de transición",
      "duration": "60 min",
  ...
  {
    "id": "teens-inter",
    "title": "Level 5, 6, 7 - Intermediate (Tigers, Sharks, Eagles)",
    "duration": "30 clases (3 meses)",
    "objective": "Fluidez conversacional en contextos sociales y académicos.",
    "mcfrEquivalent": "B1",
    "classes": [
    {
      "id": "c-teens-inter-1",
      "title": "Clase 1: Present Perfect con experiencias personales",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-inter-2",
      "title": "Clase 2: Phrasal verbs frecuentes en conversaciones adolescentes",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-inter-3",
      "title": "Clase 3: Modales de posibilidad y deducción",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-inter-4",
      "title": "Clase 4: Primer y segundo condicional",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-inter-5",
      "title": "Clase 5: Opiniones, acuerdos y desacuerdos respetuosos",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-inter-6",
      "title": "Clase 6: Proyecto podcast/debate y Simulación entrevista beca/empleo",
      "duration": "60 min",
  ...
  },
  {
    ...
    "duration": "10 clases (1 mes)",
    "objective": "Desarrollar discursos complejos y análisis crítico.",
    "mcfrEquivalent": "B2",
    "classes": [
    {
      "id": "c-teens-adv-1",
      "title": "Clase 1: Reported speech en chismes, noticias y conversaciones",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-adv-2",
      "title": "Clase 2: Relative clauses y descripción detallada",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-adv-3",
      "title": "Clase 3: Voz pasiva aplicada a noticias y tecnología",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-adv-4",
      "title": "Clase 4: Expresiones idiomáticas juveniles",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-adv-5",
      "title": "Clase 5: Tercer condicional y wish/if only",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-adv-6",
      "title": "Clase 6: Mock test IELTS/TOEFL juvenil, cierre",
      "duration": "60 min",
  ...
  },
  {
    ...
    "duration": "10 clases (1 mes)",
    "objective": "Estructuras enfáticas y persuasión.",
    "mcfrEquivalent": "C1",
    "classes": [
    {
      "id": "c-teens-elite-1",
      "title": "Clase 1: Estructuras enfáticas (Cleft sentences)",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-elite-2",
      "title": "Clase 2: Inversión en inglés formal y dramático",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-elite-3",
      "title": "Clase 3: Análisis de noticias globales",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-elite-4",
      "title": "Clase 4: Modismos avanzados (Idioms C1) y humor",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-elite-5",
      "title": "Clase 5: Preparación para estudios en el extranjero",
      "duration": "60 min",
    ...
    {
      "id": "c-teens-elite-6",
      "title": "Clase 6: Debate final, proyecto tipo TEDx",
      "duration": "60 min",
  ...
  },
  {
    ...
    "duration": "10 clases (1 mes)",
    "objective": "Dominio nativo, literatura y ética.",
    "mcfrEquivalent": "C1+",
    "classes": [
    {
      "id": "c-teens-masters-1",
      "title": "Clase 1: Acentos y dialectos globales del inglés",
      "duration": "60 min",
    ...
    },
    {
      ...
      "title": "Clase 2: Literatura, poesía y escritura creativa avanzada",
      "duration": "60 min",
    ...
    },
    {
      ...
      "title": "Clase 3: Ética, filosofía y dilemas morales",
      "duration": "60 min",
    ...
    },
    {
      ...
      "title": "Clase 4: Inglés de negocios y emprendimiento juvenil",
      "duration": "60 min",
    ...
    },
    {
      ...
      "title": "Clase 5: Producción de medios (Vlogs, Streams)",
      "duration": "60 min",
    ...
    },
    {
      ...
      "title": "Clase 6: Graduación, reflexión sobre bilingüismo y cierre definitivo",
      "duration": "60 min",
...
content = content.replace(/];\s*$/, newLevels + "\\n];");

fs.writeFileSync('src/data/curriculumTeens.ts', content, 'utf8');
console.log('Successfully updated', successCount, 'existing levels and appended 4 new levels in teens curriculum.');
