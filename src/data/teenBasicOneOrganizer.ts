...
const plans: Record<string, TeenBasicOnePlan> = {
  ...
  'c-teens-basic-1-3': {
    ...
    welcomeTitle: 'Welcome! 👕🌦️ / ¡Bienvenidos! 👕🌦️',
  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        slides: [
          addImage({ id: 'slide-19', title: 'Class Complete! 🏆 / ¡Clase completada! 🏆', description: 'Today’s achievement / Logro de hoy', content: plan.wrap, bgColor: 'bg-gradient-to-br from-yellow-400 to-orange-500' }, image(19)),
          { id: 'slide-20', title: 'Homework 📝 / Tarea 📝', description: 'Create and write. / Crea y escribe.', type: 'homework', content: plan.homework, bgColor: 'bg-gradient-to-br from-violet-500 to-fuchsia-600' },
          { id: 'slide-21', title: 'Video Homework 📹 / Tarea en video 📹', description: 'Watch, notice, and use the language.', type: 'video', videoUrl: lessonVideoUrls[cls.id] || oldVideo?.videoUrl, content: plan.videoTask, bgColor: 'bg-gradient-to-br from-slate-800 to-indigo-900' },
        ],
      },
    ],
  };
